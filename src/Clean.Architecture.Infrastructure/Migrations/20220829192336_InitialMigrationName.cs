        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LastCheckoutSessionID = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    SubscriptionLastValidDate = table.Column<DateTime>(type: "date", nullable: true),
                    NumberOfBrokersInSubscription = table.Column<int>(type: "int", nullable: false),
                    NumberOfBrokersInDatabase = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LeadLastName = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    PhoneNumber = table.Column<string>(type: "nvarchar(max)", nullable: true),
