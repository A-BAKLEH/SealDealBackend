...
namespace Infrastructure.Migrations
{
    ...
    [Migration("20220901145035_actionPlans")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Core.Domain.ActionPlanAggregate.ActionPlanAssociation", b =>
                {
                    ...
                    b.Property<int>("ActionPlanStatus")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Core.Domain.ActionPlanAggregate.ActionTracker", b =>
                {
                    ...
                    b.HasKey("ActionPlanAssociationId", "APActionId");

                    b.HasIndex("APActionId");

                    b.ToTable("ActionTrackers");
                });

            modelBuilder.Entity("Core.Domain.ActionPlanAggregate.APAction", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Core.Domain.LeadAggregate.History", b =>
                {
                    ...
                    b.Property<bool>("FromActionPlan")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("Core.Domain.ActionPlanAggregate.ActionTracker", b =>
                {
                    b.HasOne("Core.Domain.ActionPlanAggregate.APAction", "TrackedAction")
                        .WithMany("ActionTrackers")
                        .HasForeignKey("APActionId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Core.Domain.ActionPlanAggregate.APAction", b =>
                {
                    b.HasOne("Core.Domain.ActionPlanAggregate.ActionPlan", null)
                        .WithMany("Actions")
                        .HasForeignKey("ActionPlanId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Core.Domain.ActionPlanAggregate.APAction", "ParentAction")
